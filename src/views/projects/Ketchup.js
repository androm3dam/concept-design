...
const PHOTOS = [
  require(`../../assets/images/visualization/ketchup/ketchup-1.jpg`),
  require(`../../assets/images/visualization/ketchup/ketchup-2.jpg`),
  require(`../../assets/images/visualization/ketchup/ketchup-3.jpg`),
  require(`../../assets/images/visualization/ketchup/ketchup-4.jpg`),
]

function Ketchup() {
  const [isOpen, setIsOpen] = useState(false)
  const [photoIndex, setPhotoIndex] = useState(0)
  const baseSrc = "visualization/ketchup/preview/ketchup-"
  window.scrollTo(0, 0)
  return (
    <>
      <Empty />
