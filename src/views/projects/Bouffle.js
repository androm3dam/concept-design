...
const PHOTOS = [
  require(`../../assets/images/visualization/bouffle/bouffle-1.jpg`),
  require(`../../assets/images/visualization/bouffle/bouffle-2.jpg`),
  require(`../../assets/images/visualization/bouffle/bouffle-3.jpg`),
]

function Bouffle() {
  const [isOpen, setIsOpen] = useState(false)
  const [photoIndex, setPhotoIndex] = useState(0)
  const baseSrc = "visualization/bouffle/preview/bouffle-"
  window.scrollTo(0, 0)
  return (
    <>
      <Empty />
