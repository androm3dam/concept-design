...
const PHOTOS = [
  require(`../../assets/images/visualization/beer/beer-1.jpg`),
  require(`../../assets/images/visualization/beer/beer-2.jpg`),
  require(`../../assets/images/visualization/beer/beer-3.jpg`),
  require(`../../assets/images/visualization/beer/beer-4.jpg`),
  require(`../../assets/images/visualization/beer/beer-5.jpg`),
  require(`../../assets/images/visualization/beer/beer-6.jpg`),
]

function Beer() {
  const [isOpen, setIsOpen] = useState(false)
  const [photoIndex, setPhotoIndex] = useState(0)
  const baseSrc = "visualization/beer/preview/beer-"
  window.scrollTo(0, 0)
  return (
    <>
      <Empty />
