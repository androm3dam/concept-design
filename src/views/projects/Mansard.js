...
const PHOTOS = [
  require(`../../assets/images/visualization/mansard/mansard-1.jpg`),
  require(`../../assets/images/visualization/mansard/mansard-2.jpg`),
  require(`../../assets/images/visualization/mansard/mansard-3.jpg`),
  require(`../../assets/images/visualization/mansard/mansard-4.jpg`),
]

function Mansard() {
  const [isOpen, setIsOpen] = useState(false)
  const [photoIndex, setPhotoIndex] = useState(0)
  const baseSrc = "visualization/mansard/preview/mansard-"
  window.scrollTo(0, 0)
  return (
    <>
      <Empty />
